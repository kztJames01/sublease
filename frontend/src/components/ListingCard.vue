<template>
  <div class="bg-surface rounded-xl shadow-sm overflow-hidden hover:shadow-md transition group border border-border">
    <div class="relative">
      ...
      <button @click.prevent="toggleSave" class="absolute top-3 right-3 p-1.5 bg-surface/85 rounded-full hover:bg-surface transition">
